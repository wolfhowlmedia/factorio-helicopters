...
local color_list = require('stdlib/utils/defines/color_list')

--- @table color @{defines.color}
Color.color = require('stdlib/utils/defines/color')
--- @table anticolor @{defines.anticolor}
Color.anticolor = require('stdlib/utils/defines/anticolor')
--- @table lightcolor @{defines.lightcolor}
Color.lightcolor = require('stdlib/utils/defines/lightcolor')
