			...
			layers = {
				{
					...
					{
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/Chassis_Lo-0.png",
							width_in_frames = 1,
							height_in_frames = 1,
						},
					},
...
----------------------flying collision--------------------
	{
		type = "car",
		name = "heli-scout-flying-collision-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
...
----------------------landed collision--------------------
	{
		type = "car",
		name = "heli-scout-landed-collision-side-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
		flags = { "placeable-off-grid", "not-on-map" },
		-- render_layer = "air-object",
	...
	{
		type = "car",
		name = "heli-scout-landed-collision-end-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
		flags = { "placeable-off-grid", "not-on-map" },
		-- render_layer = "air-object",
			...
			layers = {
				{
					...
					stripes =
					{
						...
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/Chassis_Lo-1.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/Chassis_Lo-2.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/Chassis_Lo-3.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
					},
	...
	{
		type = "car",
		name = "heli-scout-shadow-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
		flags = { "placeable-off-grid", "not-on-map" },
		-- render_layer = "air-object",
			...
			layers = {
				{
					...
					{
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/ChassisShadow_Lo-0.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/ChassisShadow_Lo-1.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/ChassisShadow_Lo-2.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
						{
							filename = "__HelicopterRevival__/graphics/entities/heli_scout/ChassisShadow_Lo-3.png",
							width_in_frames = 4,
							height_in_frames = 4,
						},
					},
...
----------------------smoke and sound--------------------
	{
		type = "car",
		name = "heli-scout-burner-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
		flags = { "placeable-off-grid", "not-on-map" },
		render_layer = "air-object",
		...
		working_sound = {
			sound = {
				filename = "__HelicopterRevival__/sound/scout_loop.ogg",
				volume = 0.6
			},
			activate_sound = {
				filename = "__HelicopterRevival__/sound/scout_startup.ogg",
				volume = 0.6
			},
			deactivate_sound = {
				filename = "__HelicopterRevival__/sound/scout_shutdown.ogg",
				volume = 0.6
			},
...
----------------------flashlight--------------------
	{
		type = "car",
		name = "heli-scout-floodlight-entity-_-",
		icon = "__HelicopterRevival__/graphics/icons/heli.png",
		icon_size = 64,
		flags = { "placeable-off-grid", "not-on-map" },
		minable = { mining_time = 1, result = "helicopter" },
